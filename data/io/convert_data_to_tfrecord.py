...
tf.app.flags.DEFINE_string('VOC_dir', '/data/yangxue/dataset/OHD-SJTU-ALL/crop_head/trainval', 'Voc dir')
...
tf.app.flags.DEFINE_string('dataset', 'OHD-SJTU-ALL-HEAD-600', 'dataset')
...
def read_xml_gtbox_and_label(xml_path):
    ...
    :return: a list contains gtboxes and labels, shape is [num_of_gtboxes, 9],
           and has [x1, y1, x2, y2, x3, y3, x4, y4, head_x, head_y, label] in a per row
    """
